...
import "./ProductHeadphone3.css";
import productnew1 from "../assets/images3/product-new1.png";
import productnew2 from "../assets/images3/product-new2.png";
import productnew3 from "../assets/images3/product-new3.png";
import productnew4 from "../assets/images3/product-new4.png";
...
const ProductHeadphone3: React.FC = () => {
    ...
    <main className="product-page">
      ...
      <section className="product-details">
        <div className="wrapper">
          <div className="product-main">
            <div className="product-image-box">
              <img src={productnew1} alt={productnew1} className="imgg" />
            </div>
        ...
        <div className="gallery">
          <img className="img0" src={productnew2} alt="gallery 1" />
          <img className="img0" src={productnew3} alt="gallery 2" />
          <img className="img01" src={productnew4} alt="gallery 3" />
        </div>
...
export default ProductHeadphone3;
