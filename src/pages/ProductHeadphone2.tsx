...
import "./ProductHeadphone2.css";
import productno1 from "../assets/images3/product-no1.png";
import productno2 from "../assets/images3/product-no2.png";
import productno3 from "../assets/images3/product-no3.png";
import productno4 from "../assets/images3/product-no4.png";
...
const ProductHeadphone2: React.FC = () => {
    ...
    <main className="product-page">
      ...
      <section className="product-details">
        <div className="wrapper">
          <div className="product-main">
            <div className="product-image-box">
              <img src={productno1} alt={productno1} className="imgg" />
            </div>

            <div className="product-info">
              <p className="new-label">NEW PRODUCT</p>
              <h2 className="product-title">XX99 MARK I HEADPHONES</h2>
        ...
        <div className="gallery">
          <img className="img0" src={productno2} alt="gallery 1" />
          <img className="img0" src={productno3} alt="gallery 2" />
          <img className="img01" src={productno4} alt="gallery 3" />
        </div>
...
export default ProductHeadphone2;
