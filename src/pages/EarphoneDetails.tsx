...
import "./EarphoneDetails.css";
import ear1 from "../assets/images3/earphone1.png";
import ear2 from "../assets/images3/earphone2.png";
import ear3 from "../assets/images3/earphone3.png";
import ear4 from "../assets/images3/earphone4.png";
    ...
    <main className="product-page">
      ...
      <section className="product-details">
        <div className="wrapper">
          <div className="product-main">
            <div className="product-image-box">
              <img src={ear1} alt={ear1} className="imgg" />
            </div>
        ...
        <div className="gallery">
          <img className="img0" src={ear2} alt="gallery 1" />
          <img className="img0" src={ear3} alt="gallery 2" />
          <img className="img01" src={ear4} alt="gallery 3" />
        </div>
