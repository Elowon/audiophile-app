...
import speak1 from "../assets/images3/speaker1.png";
import speak2 from "../assets/images3/speaker2.png";
import speak3 from "../assets/images3/speaker3.png";
import speak4 from "../assets/images3/speaker4.png";
    ...
    <main className="product-page">
      ...
      <section className="product-details">
        <div className="wrapper">
          <div className="product-main">
            <div className="product-image-box">
              <img src={speak1} alt={speak1} className="imgg" />
            </div>
        ...
        <div className="gallery">
          <img className="img0" src={speak2} alt="gallery 1" />
          <img className="img0" src={speak3} alt="gallery 2" />
          <img className="img01" src={speak4} alt="gallery 3" />
        </div>
