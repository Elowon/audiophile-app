...
import "./ProductHeadphone1.css";
import product1 from "../assets/images3/product-img1.png";
import product2 from "../assets/images3/product-img2.png";
import product3 from "../assets/images3/product-img3.png";
import product4 from "../assets/images3/product-img4.png";
...
const ProductHeadphone1: React.FC = () => {
    ...
    <main className="product-page">
      ...
      <section className="product-details">
        <div className="wrapper">
          <div className="product-main">
            <div className="product-image-box">
              <img src={product1} alt={product1} className="imgg" />
            </div>
        ...
        <div className="gallery">
          <img className="img0" src={product2} alt="gallery 1" />
          <img className="img0" src={product3} alt="gallery 2" />
          <img className="img01" src={product4} alt="gallery 3" />
        </div>
...
export default ProductHeadphone1;
